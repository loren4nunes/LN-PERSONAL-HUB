    ...
    <div className="min-h-screen bg-background font-outfit text-foreground">
      ...
      <header className="flex items-center justify-between px-6 py-6 md:px-12">
        <div className="flex items-center gap-3">
          <img
            src={`${import.meta.env.BASE_URL}logo-lorena-simbolo.png`}
      ...
      <section id="sou-aluno" className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="text-balance text-4xl font-black uppercase italic tracking-tighter md:text-5xl">
            Sou <span className="text-brand-lime">Aluno</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            Acesse sua conta para ver seu treino, seu plano e sua evolução.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              to="/auth"
              className="bg-brand-lime px-8 py-4 text-sm font-black uppercase tracking-widest text-brand-dark transition-transform hover:scale-105"
            >
              Entrar na minha conta
            </Link>
            <Link
              to="/auth"
              className="border border-white/20 px-8 py-4 text-sm font-black uppercase tracking-widest transition-colors hover:bg-white/10"
            >
              Criar conta
            </Link>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 block text-xs uppercase tracking-widest text-brand-lime transition-colors hover:text-brand-lime/80"
          >
            Preciso de suporte · falar no WhatsApp
          </a>
        </div>
      </section>
